...
type ManagerProfileUser = AuthUser & {
  status?: string | null;
 ...
 */
function getStoredUser(): ManagerProfileUser | null {
  ...
  try {
    return JSON.parse(user) as ManagerProfileUser;
  } catch {
    return null;
  }
}
...
export default function ManagerProfilePage() {
   ...
   */
  const [user, setUser] = useState<ManagerProfileUser | null>(null);
          ...
          <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-white/65">
                View your manager identity, role, department, designation and
                contact information.
              </p>
            </div>
          ...
          <CardContent className="p-5 sm:p-6">
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm text-white/50">
                Your current manager profile information.
              </p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <DetailRow
                label="Manager Scope"
                value="Assigned team members only"
              />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border border-amber-100/10 bg-[#17100b]/75 text-white shadow-xl shadow-black/20">
          <CardContent className="p-5">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
              ...
              <div>
                <h3 className="font-black text-white">Manager Access</h3>
                <p className="mt-2 text-sm leading-6 text-white/55">
                  Manager pages are designed to show only assigned team data.
                  Admin and Super Admin users continue to manage organization
                  level data from Admin Dashboard.
                </p>
              </div>
            </div>
          </CardContent>
